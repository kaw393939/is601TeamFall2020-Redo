...
Forking vs cloning is useful because if you add a collaborator/partner, and you are training some other people, you don't trust the other people or their code skills. If they are added as collaborators then they can merge their code into the project without any approval. By forking, you create a complete separate sandbox to work in, and you send your changes to the owner leaving it up to them to manage and control the changes.